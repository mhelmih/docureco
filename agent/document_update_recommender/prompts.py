...
```diff
  ...
  |-----|-----------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  | F0X | Requirement statement 1                                   | Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. |
- | F0X | The software must allow users to add new book.            | The software allows users to add new books by entering the book title, number of pages, and status. The system performs basic validation to ensure required fields are filled and page count is a positive integer. |
- | F0X | The software must allow users to view list of books.      | The user can view the list of books (with title, number of pages, status, reading start date and time, number of days since starting, number of times read, and the last page read) stored in the software. The user can also view the number of books to be read, currently being read, and already read. |
+ | F0X | The software must allow users to add new book.            | The software allows users to add new books by entering the book title, number of pages, status, and whether it is a favorite. The system performs basic validation to ensure required fields are filled and page count is a positive integer. |
