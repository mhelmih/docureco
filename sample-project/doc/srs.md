...
| F06 | The software must allow users to view personal notes.     | The user can view the personal notes of a book (with note content, page number, and favorite status if integrated) stored in the software.                                                                                                                                                                                                                                                                                                                                                                                |
...
| UC03 | View book details  | The system displays book data, including favorite status, along with the reading progress data for each book.                        |
...
| UC05 | View notes         | The system shows the notes available in the database, potentially integrated with favorite status for book-specific notes.           |
